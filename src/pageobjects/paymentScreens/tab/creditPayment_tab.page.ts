...
class CreditPaymentTab extends Page {
    //selectors
    public get chargeAmountField () {
        return $('//android.widget.EditText[@resource-id="tenfore.birdie:id/frpcr7_etPayAmount"]'); //update for tabs
    };
...
export default new CreditPaymentTab();